...
;(function(factory) {
    ...
    OPS.prototype.init = function() {
        ...
        //Set transition
        _.$this.css({"transition": "top "+ (_.duration/1000) + "s, left "+ (_.duration/1000) + "s "+ _.easing +""});
    ...
    OPS.prototype.renderPag = function() {
        ...
        if( _.$childrens.length ) {
            ...
            var $pagesWrap = $("#ops-pagination .wrap");
            var points = '';
            ...
            $("#ops-pagination .ops-pagination_item:first").addClass("active");
    ...
    OPS.prototype.setPage = function( difference, page ) {
        ...
        if( $nextPage.length && ( $nextPage.attr("one-page-current") !== 'true' || difference == 'refresh' ) ) {
            ...
            $("#ops-pagination .active").removeClass("active");
            $( $("#ops-pagination .ops-pagination_item")[$nextPage.index()] ).addClass("active");
